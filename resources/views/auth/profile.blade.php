                        ...
                        <div class = "grid grid-cols-2 gap-6">
                            <div class = "grid grid-rows-2 gap-6">
                                ...
                                <div class = "mt-4">
                                    ...
                                    <x-text-input id="bloodType" class="block mt-1 w-full" type="text" name="bloodType" value="{{ auth()->user()->bloodType }}" autofocus readonly/>
                                </div>
                                ...
                                <div class = "mt-4">
                                    ...
                                    <x-text-input id="stateID" class="block mt-1 w-full" type="text" name="stateID" value="{{ auth()->user()->stateID }}" autofocus />
                                </div>
                            </div>
